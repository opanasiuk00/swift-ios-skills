...
Replace `48 48` and `24 24` with the actual pixel dimensions for the asset. Target sizes must match the Figma display size multiplied by scale. Example: a 24pt square icon exports to 72x72px at 3x, 48x48px at 2x, and 24x24px at 1x.
